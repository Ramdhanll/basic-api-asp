!(function (e, a) {
   ...
   function e(r, d) {
      ...
      return I(function () {
         if (
            (null != M.deprecationHandler && M.deprecationHandler(null, r), i)
         ) {
              ...
              : ((e._a = a),
                (e._tzm =
                   ...
                   t
                      ...
                      : s
                      ? 0
                      : 60 * (((t = parseInt(n, 10)) - (s = t % 100)) / 100) +
                        s)),
         ...
         !(function (e) {
            ...
            for (n = 0; n < _; n++)
               (r = 0),
                  ...
                  G(a) && (d = !0),
                  (r =
                     (r += h(a).charsLeftOver) + 10 * h(a).unusedTokens.length),
                  (h(a).score = r),
                  i
                     ? r < s && ((s = r), (t = a))
                     : (null == s || r < s || d) &&
      ...
      A =
         ...
         }),
         {
            ...
            translate: function (e, a, t, s) {
               var n = A.words[t]
               if (1 === t.length)
                  return 'y' === t && a ? 'jedna godina' : s || a ? n[0] : n[1]
               s = A.correctGrammaticalCase(e, n)
               return 'yy' === t && a && 'godinu' === s
                  ? e + ' godina'
                  : e + ' ' + s
            },
         }),
      ...
      ordinal: function (e, a) {
         switch (a) {
            ...
            default:
               ...
               var t = e % 10
               return (
                  e + (xn[t] || xn[(e % 100) - t] || xn[100 <= e ? 100 : null])
               )
         }
      },
      week: { dow: 1, doy: 7 },
